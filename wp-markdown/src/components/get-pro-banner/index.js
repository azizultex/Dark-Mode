        ...
        return (
            <div className="components-markdown-gopro components-markdown-gopro-hidden">
                <div className="markdown-gopro-inner">
                    ...
                    <h3 className="discount">GET <span class="percentage">50%</span> OFF</h3>
                    <h3 className="limited-title">LIMITED TIME ONLY</h3>
                    <div className="simple_timer"></div>
                    <Button href="https://wppool.dev/wp-markdown-editor" target="_blank" className="wpmd-pro-btn">GET PRO</Button>
                </div>
            </div>
        )
    }
